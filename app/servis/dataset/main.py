...
IMAGE_PATH = r"shema/2.png"
MODEL_PATH = "flowchart_model.keras"
...
def main():
    ...
    code = generate_smart_code(results, connections)

    with open("output_flowchart.py", "w", encoding="utf-8") as f:
        f.write(code)
